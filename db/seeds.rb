...
Teacher.find_by(email: "lllouis1@yahoo.com").destroy
Teacher.find_by(email: "lllouis2@yahoo.com").destroy
Teacher.find_by(email: "lllouis3yahoo.com").destroy
Teacher.find_by(email: "lllouis4@yahoo.com").destroy
Teacher.find_by(email: "lllouis5@yahoo.com").destroy
Teacher.find_by(email: "lllouis6@yahoo.com").destroy
Teacher.find_by(email: "lllouis7@yahoo.com").destroy
Teacher.find_by(email: "lllouis8@yahoo.com").destroy
Teacher.find_by(email: "lllouis9@yahoo.com").destroy
Teacher.find_by(email: "lllouis10@yahoo.com").destroy
Teacher.find_by(email: "lllouis11@yahoo.com").destroy