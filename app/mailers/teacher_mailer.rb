    ...
    begin
      ...
      message = {  
       ...
       :text=> %Q(<html>Reset your password  <br>
                <p><a href="#{ root_url }api/auth/password/edit?config=default&redirect_url=http%3A%2F%2Flocalhost%3A3000%2F%23%2Freset-password%2F&reset_password_token=#{ token }">Change my password</a></p>),
